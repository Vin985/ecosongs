...
res.loc[res.site == "East Bay", "panel"] = 4
res.loc[res.site == "Igloolik", "panel"] = 5
res.loc[res.site == "Canning River", "panel"] = 3
res.loc[res.site == "Burntpoint Creek", "panel"] = 2
...
(ggplot(data=res, mapping=aes(x='julian', y='ACI_mean', colour='site'))
 ...
 + facet_wrap("panel", nrow=2, ncol=3)
    ...
    + scale_x_continuous(labels=label_x)).save("figs/asm2019_aci.png", height=10, width=16, dpi=150)
