...
class Ui_FileImport(object):
    def setupUi(self, FileImport):
        ...
        self.gridLayout_5.addWidget(self.radio_tar, 4, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.radio_zip, 3, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pushButton, 4, 4, 1, 1)
        self.input_dest_path = QtWidgets.QLineEdit(self.widget_2)
        self.input_dest_path.setObjectName("input_dest_path")
        self.gridLayout_7.addWidget(self.input_dest_path, 4, 0, 1, 4)
        self.radioButton_4 = QtWidgets.QRadioButton(self.widget_2)
        self.radioButton_4.setChecked(True)
        self.radioButton_4.setObjectName("radioButton_4")
        self.radio_data_source = QtWidgets.QButtonGroup(FileImport)
        self.radio_data_source.setObjectName("radio_data_source")
        self.radio_data_source.addButton(self.radioButton_4)
        self.gridLayout_7.addWidget(self.radioButton_4, 1, 0, 1, 1)
        self.checkbox_datasource = QtWidgets.QCheckBox(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkbox_datasource.sizePolicy().hasHeightForWidth())
        self.checkbox_datasource.setSizePolicy(sizePolicy)
        self.checkbox_datasource.setObjectName("checkbox_datasource")
        self.gridLayout_7.addWidget(self.checkbox_datasource, 5, 0, 1, 1)
        self.combo_datasource = QtWidgets.QComboBox(self.widget_2)
        self.combo_datasource.setObjectName("combo_datasource")
        self.gridLayout_7.addWidget(self.combo_datasource, 2, 0, 1, 4)
        self.radioButton_5 = QtWidgets.QRadioButton(self.widget_2)
        self.radioButton_5.setObjectName("radioButton_5")
        self.radio_data_source.addButton(self.radioButton_5)
        self.gridLayout_7.addWidget(self.radioButton_5, 3, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.label_14, 5, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.input_datasource, 5, 2, 1, 2)
        ...
        self.idx_2.setCurrentIndex(1)
        self.idx_1.setCurrentIndex(2)
    ...
    def retranslateUi(self, FileImport):
        ...
        self.pushButton.setText(QtWidgets.QApplication.translate("FileImport", "Browse...", None, -1))
        self.radioButton_4.setText(QtWidgets.QApplication.translate("FileImport", "Select existing data source", None, -1))
        self.checkbox_datasource.setText(QtWidgets.QApplication.translate("FileImport", "Add new destination as data source", None, -1))
        self.radioButton_5.setText(QtWidgets.QApplication.translate("FileImport", "Select new destination folder", None, -1))
