...
class Ui_Ecosongs(object):
    def setupUi(self, Ecosongs):
        ...
        self.gridLayout.addWidget(self.srcBrowseBtn, 2, 2, 1, 1)
        self.destBrowseBtn = QtWidgets.QPushButton(self.groupBox)
        self.destBrowseBtn.setObjectName("destBrowseBtn")
        self.gridLayout.addWidget(self.destBrowseBtn, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.logConsole, 4, 0, 1, 3)
        ...
        Ecosongs.setTabOrder(self.isFolder, self.isFile)
        Ecosongs.setTabOrder(self.isFile, self.srcPathInput)
        ...
        Ecosongs.setTabOrder(self.logConsole, self.convertBtn)
